# Generated by Django 2.0 on 2019-09-16 02:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.FileField(default='uploading_file/default.png', upload_to='myapp/uploading_file/', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='myapp.Article')),
            ],
        ),
        migrations.CreateModel(
            name='ArticleUpDown',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Article')),
                ('parent_comment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.Comment')),
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(through='myapp.Article2Tag', to='myapp.Tag'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
        ...
        migrations.AddField(
            model_name='userinfo',
            name='blog',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.Blog'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='groups',
